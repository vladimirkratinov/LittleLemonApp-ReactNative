      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color, size }) => {
            ...
            // You can return any component here that you like. Example: 
            return <Ionicons name={iconName} size={size} color={color} />;
          },
        })}
      >
        <Tab.Screen name="Welcome" component={WelcomeScreen} options={{headerShown: false}} />
        <Tab.Screen name="SectionList" component={SectionListMenu} options={{headerShown: false}}/>
        <Tab.Screen name="FlatList" component={FlatListMenu} options={{headerShown: false}}/>
        <Tab.Screen name="ScrollList" component={ScrollListMenu} options={{headerShown: false}}/>
      </Tab.Navigator>
    </NavigationContainer>
  );
};
